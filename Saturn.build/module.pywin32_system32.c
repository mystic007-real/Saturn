...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UN_TRANSLATE("pywin32_system32"));
...
PyObject *modulecode_pywin32_system32(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    ...
    UPDATE_STRING_DICT0(moduledict_pywin32_system32, (Nuitka_StringObject *)const_str_plain___loader__, Nuitka_Loader_New(loader_entry));
...
// Mark the execution in the "__spec__" value.
    ...
    // Module code.
 {
  ...
  tmp_call_arg_element_2 = MAKE_LIST1(tstate, mod_consts[3]);
  ...
  UPDATE_STRING_DICT1(moduledict_pywin32_system32, (Nuitka_StringObject *)mod_consts[4], tmp_assign_source_1);
 }
